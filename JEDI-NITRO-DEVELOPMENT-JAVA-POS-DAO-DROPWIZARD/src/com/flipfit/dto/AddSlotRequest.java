...
/**
 * The Class AddSlotRequest.
 * DTO for adding a new slot requests.
 *
...
public class AddSlotRequest {
    ...
    /**
     * Instantiates a new add slot request.
     */
    public AddSlotRequest() {}

    /**
     * Instantiates a new add slot request with specified values.
     *
     * @param startTime the start time
     * @param endTime the end time
     * @param totalSeats the total seats
     */
    public AddSlotRequest(LocalTime startTime, LocalTime endTime, int totalSeats) {
